				...
				<el-card class="commodity-card" shadow="hover">
					...
					<div class="bottom">
						<p>
							...
							￥
							<router-link class="transition-btn pink-btn" to="/shopping-cart">{{ $t('mall.payDeposit') }}</router-link>
						</p>
					</div>
				</el-card>
			</el-col>
...
getOriginalCommodityList({ type: 'presale' }).then((res) => {
